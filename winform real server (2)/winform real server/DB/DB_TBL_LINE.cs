...
namespace winform_real_server
{
    class DB_TBL_LINE1
    {
        ...
        public DB_TBL_LINE1(string _id, string line_id ,string oper_name, string state, string working_lot, string line_temp, string line_humidity, string lot_reserve)
        {
            _Id = _id;
            Line_id = line_id;
            Oper_name = oper_name;
